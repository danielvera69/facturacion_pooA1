...
alumnos = [{"nombre":"Ana","edad":20},alumno]
alumno['nombre']="Elian"
alumno["nota"]=70 # si no existe,crea la clave nota con el valor 70
print(numeros)
print(usuario)
print(alumno.items())
...
cadena2= "|".join(datos2)# "ana|30|500.50"  
dat = cadena2.split("|") # ["ana","30","500.50"]
# print(cadena2)
# nume =[    20      ,     40,              50]
    #       0            1                 2
